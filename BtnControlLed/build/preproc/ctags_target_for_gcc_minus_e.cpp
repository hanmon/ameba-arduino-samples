# 1 "d:\\project\\ameba-arduino-samples\\BtnControlLed\\BtnControlLed.ino"
/*
...
*/
# 10 "d:\\project\\ameba-arduino-samples\\BtnControlLed\\BtnControlLed.ino"
//D3外接下拉電阻，為正向邏輯的電路，D9外接LED並串上適當的電阻，或使用模組
const byte btnPin = 3;// 按鈕連接在D3，正向邏輯
const byte ledPin = 9;// LED 連接在D9
bool btnState = 0x0; //存放讀取值的bool變數

void setup() {
  Serial.begin(115200);
  Serial.print("Example:BtnControlLed");
  pinMode(btnPin, 0x00); //設定D3為輸入
  pinMode(ledPin, 0x01); //設定D9為輸出
}
